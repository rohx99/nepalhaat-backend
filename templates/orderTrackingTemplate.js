                    ...
                    <tr>
                        <td style="background-color: #0D1627; padding: 40px 20px; text-align: center; color: #F88700;">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td style="font-size: 16px; padding-top: 10px;">Your package is on its way. Track it
                                        using the details below.</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 30px 20px;">
                                ...
                                <tr>
                                    <td>
                                        <table width="100%" border="0" cellspacing="0" cellpadding="8">
                                            ...
                                            <tr style="border-bottom: 1px solid #e9ecef;">
                                                <td style="color: #666666;">Tracking ID:</td>
                                                <td style="font-weight: bold; text-align: right;">{trackingId}</td>
                                            </tr>
                                            <tr style="border-bottom: 1px solid #e9ecef;">
                                                <td style="color: #666666;">Courier Service:</td>
                                                <td style="font-weight: bold; text-align: right;">{trackingCompany}</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                ...
                                <tr>
                                    <td style="font-weight: bold; color: #856404; padding-bottom: 10px;">Delivery
                                        Information</td>
                                </tr>
                                <tr>
                                    <td style="color: #856404;">Your order has been shipped via {trackingCompany}. You
                                        can track its progress using the tracking link above. If you have any questions,
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                ...
                                <tr>
                                    <td>
                                        <a href="{trackingLink}"
                                            style="display: inline-block; background-color: #F88700; color: #ffffff; text-decoration: none; padding: 12px 24px; font-weight: bold; font-size: 16px;">Track
                                            Your Order</a>
                                    </td>
                                </tr>
                            </table>

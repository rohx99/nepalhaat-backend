                    ...
                    <tr>
                        <td style="background-color: #0D1627; padding: 40px 20px; text-align: center; color: #F88700;">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                    <td style="font-size: 28px; font-weight: bold;">Your Order Has Been Placed!</td>
                                </tr>
                                <tr>
                                    <td style="font-size: 16px; padding-top: 10px;">Thank you for your order. You'll
                                        receive a confirmation email soon.</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="padding: 30px 20px;">
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0"
                                ...
                                <tr>
                                    <td style="font-weight: bold; color: #856404; padding-bottom: 10px;">Order
                                        Information</td>
                                </tr>
                                <tr>
                                    <td style="color: #856404;">Your order has been successfully placed and is awaiting
                                        confirmation. You will receive a confirmation email shortly. glandular. If you
                                        have any questions, please contact our customer service team.</td>
                                </tr>
                            </table>
                            <!-- CTA Button -->
                            <table width="100%" border="0" cellspacing="0" cellpadding="0"
